...
public abstract class PageView extends ViewGroup {
	...
	private       View mBusyIndicator = null;
	...
	public void blank(int page) {
		...
		if (mBusyIndicator == null) {
			...
			mBusyIndicator    =  LayoutInflater.from(mContext).inflate(R.layout.materail_progress_bar, null);
			//mBusyIndicator.setIndeterminate(true);
			//mBusyIndicator.setBackgroundResource(R.drawable.pdet_busy);
